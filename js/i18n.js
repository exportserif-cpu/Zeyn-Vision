...
window.ZV_I18N =   {
    ar: {
      ...
      worksPage: {
        kicker: "أعمالنا ودراسات الحالة",
        title: "من التحدي الهندسي إلى النتائج الملموسة",
        sub: "ست دراسات حالة مختارة عبر الصناعات — كل مشروع يحكي قصة تحدٍ، حلٍّ تقني، ونتائج رقمية قابلة للقياس.",
        challenge: "التحدي الهندسي",
        solution: "الحل التقني",
        results: "النتائج",
        ctaTitle: "مشروعك القادم هنا",
        ctaSub: "أخبرنا عن التحدي الذي تواجهه — وسنرسم لك الحل.",
        ctaBtn: "ابدأ مشروعك",
        p1c: "لوحة تحكم كانت تتعامل مع ملايين الأحداث يومياً بتأخير متزايد، وعدم قدرة على التوسع مع نمو البيانات.",
        p1s: "بنية بث لحظية قائمة على Kafka مع معالجة دفقية في الذاكرة، ولوحة تحكم مصممة للتعامل مع 4M حدث/يوم بتأخير أقل من 200ms.",
        p2c: "توصيات عامة لم ترفع التحويل، وافتقار النظام إلى فهم سلوك المستخدم الفردي.",
        p2s: "محرك توصيات تعلّم ذاتي يدمج التصفية التعاونية وتحليل السلوك اللحظي، مبنياً على بنية قابلة للتوسع.",
        p3c: "متجر بطيء يخسر العملاء ويرتبك في نتائج البحث بسبب مؤشرات أداء ضعيفة.",
        p3s: "إعادة بناء كاملة بواجهة أمامية خفيفة وخادم محسّن، محققاً LCP بمقدار 0.8 ثانية ونتيجة 100 في Lighthouse.",
        p4c: "هوية بصرية متفرقة عبر منتجات متعددة، بلا نظام تصميم موحّد يحكم الشكل والاستخدام.",
        p4s: "بناء نظام تصميم متكامل (Design System) بألوان وخطوط ومكوّنات موحدة، قابل للتوسع عبر 12 منتجاً.",
        p5c: "أحمال دعم متزايدة وتذاكر متكررة تستهلك وقت الفريق التشغيلي.",
    ...
    en: {
      ...
      worksPage: {
        ...
        title: "From engineering challenge to tangible results",
        sub: "Six selected case studies across industries — each project tells a story of a challenge, a technical solution, and measurable digital results.",
        challenge: "Engineering Challenge",
        solution: "Technical Solution",
        results: "Results",
        ctaTitle: "Your next project starts here",
        ctaSub: "Tell us the challenge you face — we will design the solution.",
        ctaBtn: "Start Your Project",
        p1c: "A dashboard handling millions of events daily with growing latency, unable to scale with data growth.",
        p1s: "A real-time streaming architecture on Kafka with in-memory stream processing, built to handle 4M events/day with under 200ms latency.",
        p2c: "Generic recommendations failed to lift conversion, and the system lacked insight into individual user behavior.",
        p2s: "A self-learning recommendation engine combining collaborative filtering with real-time behavioral analytics on a scalable architecture.",
        p3c: "A slow store losing customers and struggling in search rankings due to weak performance metrics.",
        p3s: "A complete rebuild with a lightweight frontend and optimized backend, achieving 0.8s LCP and a perfect 100 Lighthouse score.",
        p4c: "Fragmented visual identity across multiple products, with no unified design system governing form and usage.",
        p4s: "An integrated design system with unified colors, typography and components, scalable across 12 products.",
        p5c: "Rising support loads and repetitive tickets consuming the operations team's time.",
    ...
    tr: {
      ...
      worksPage: {
        kicker: "İşlerimiz ve Vaka Çalışmaları",
        title: "Mühendislik zorluğundan somut sonuçlara",
        sub: "Sektörler arası seçilmiş altı vaka çalışması — her proje bir zorluk, teknik çözüm ve ölçülebilir dijital sonuç hikâyesi anlatır.",
        challenge: "Mühendislik Zorluğu",
        solution: "Teknik Çözüm",
        results: "Sonuçlar",
        ctaTitle: "Bir sonraki projeniz burada başlıyor",
        ctaSub: "Karşılaştığınız zorluğu anlatın — çözümü birlikte tasarlayalım.",
        ctaBtn: "Projenizi Başlatın",
        p1c: "Günde milyonlarca olayı artan gecikmeyle işleyen ve veri büyümesiyle ölçeklenemeyen bir gösterge paneli.",
        p1s: "Kafka üzerinde gerçek zamanlı akış mimarisi ve bellek içi akış işleme; günde 4M olayı 200ms altında gecikmeyle işleyecek şekilde tasarlandı.",
        p2c: "Genel öneriler dönüşümü artıramadı ve sistem bireysel kullanıcı davranışına dair içgörüden yoksundu.",
        p2s: "İşbirlikçi filtreleme ile gerçek zamanlı davranış analitiğini birleştiren, ölçeklenebilir mimari üzerine kendi kendine öğrenen öneri motoru.",
        p3c: "Zayıf performans ölçütleri nedeniyle müşteri kaybeden ve arama sıralamasında zorlanan yavaş bir mağaza.",
        p3s: "Hafif ön yüz ve optimize edilmiş arka uçla tam yeniden yapım; 0,8 sn LCP ve 100 Lighthouse puanı elde edildi.",
        p4c: "Birden çok üründe dağınık görsel kimlik; biçimi ve kullanımı yöneten birleşik bir tasarım sistemi yoktu.",
        p4s: "Renk, tipografi ve bileşenleri birleştiren, 12 üründe ölçeklenebilir entegre tasarım sistemi.",
        p5c: "Artan destek yükü ve tekrarlayan biletler operasyon ekibinin zamanını tüketiyordu.",
